...
# Set page config
st.set_page_config(page_title="Stock Scoring & Advisory System", layout="wide", page_icon="📈")
...
# Title
st.title("Stock Scoring & Advisory System")
...
# Footer
st.markdown("---")
st.markdown("Stock Scoring & Advisory System - Data provided by Yahoo Finance")
